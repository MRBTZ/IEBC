<?php 
	...
	class Roles extends Controllers{
		...
		public function Roles()
		{
			...
			$data['page_title'] = "Roles Usuario  <small>  Sistema IEBC  </small> ";
...
//RECIBE LOS DATOS PARA LA ACTUALIZACION extraer un solo rol -------------------------------------------------------------- 
...
//CREAR UN ROL  -------------------------------------------------------------- 
		...
		public function setRol(){
			...
			$intIdrol = intval($_POST['idRol']); //la captura del id del rol que se va a enviar
